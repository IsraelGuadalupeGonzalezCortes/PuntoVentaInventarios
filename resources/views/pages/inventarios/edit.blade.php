                    ...
                    <form action="{{ route('inventarios.update', $inventario) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="fecha_entrada" id="fecha_entrada" class="form-input mt-1 block w-full" value="{{ $inventario->fecha_entrada }}" required>
                            </div>
                            <div>
                                <label for="fecha_salida" class="block text-sm font-medium text-gray-700">Fecha de Salida</label>
                                <input type="date" name="fecha_salida" id="fecha_salida" class="form-input mt-1 block w-full" value="{{ $inventario->fecha_salida }}">
                            </div>
                            <div>
                                <label for="movimiento" class="block text-sm font-medium text-gray-700">Movimiento</label>
                                <input type="text" name="movimiento" id="movimiento" class="form-input mt-1 block w-full" value="{{ $inventario->movimiento }}" required>
                            </div>
                            <div>
                                <label for="motivo" class="block text-sm font-medium text-gray-700">Motivo</label>
                                <input type="text" name="motivo" id="motivo" class="form-input mt-1 block w-full" value="{{ $inventario->motivo }}">
                            </div>
                            <div>
                                <label for="cantidad" class="block text-sm font-medium text-gray-700">Cantidad</label>
                                <input type="number" name="cantidad" id="cantidad" class="form-input mt-1 block w-full" value="{{ $inventario->cantidad }}" required>
                            </div>
                        </div>
                        <div class="mt-6">
